...
print("  4. if the PLC is ready, the order will move to Dispatched and wait for conv_start")
...
print("  7. when conv_start=True then conv_end=True arrive, the order should move to Completed")
